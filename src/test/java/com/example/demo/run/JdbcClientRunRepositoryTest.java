...
//@SpringBootTest will configure the whole application context so you have access to all the
// beans and components, we don't need that sometimes
//Slice test
@JdbcTest
@Import(JdbcClientRunRepository.class)
@AutoConfigureTestDatabase(replace = NONE)
class JdbcClientRunRepositoryTest {
//    we are not trying to test the test so it's ok not to use construction injection
    @Autowired
